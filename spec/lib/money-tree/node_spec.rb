      ...
      describe "from a seed" do
        ...
        describe "m" do
          ...
          it "generates master node (Master)" do
            ...
            expect(@master.to_address(format: :p2sh_p2wpkh)).to eql("3PpgpssV7mcAGpZRWiCWhodUTnjpoSZg7a")
          end
        ...
        describe "m/0p" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3AbBmNbPDSzeZKHywDrH3h5v2rL8xGfT7e")
          end
        ...
        describe "m/0'/1" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3DymAvEWH38HuzHZ3VwLus673bNZnYwNXu")
          end
        ...
        describe "m/0'/1/2p/2" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3PxPuCJMQGgkPYArciuUFakdiKC58j3Df6")
          end
        ...
        describe "m/0'/1/2'/2/1000000000" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3BuqWierKkrD7XEeJL4hucMGqVCe5G4WK7")
          end
      ...
      describe "from a seed" do
        ...
        describe "m" do
          ...
          it "generates master node (Master)" do
            ...
            expect(@master.to_address(format: :p2sh_p2wpkh)).to eql("3QaGQQTfBvSxXnsggeGxF3zfTAo3uyeREG")
          end
        ...
        describe "m/0 (testing imported private key)" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("39cFMGtVaEw6AfksMcaLpu8frZxmqngh8c")
          end
        ...
        describe "m/0/2147483647'" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("39oYp2KWMueN9LSVyDGUGAeDeAgdj43suV")
          end
        ...
        describe "m/0/2147483647'/1" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3McFiyStLZ4GzqN9Hx7rG7iyVjaX5Hf7VH")
          end
        ...
        describe "m/0/2147483647p/1/2147483646p" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("35aip4nbX3wM2V3NMxHgPz1wEUQ2T7BJPY")
          end
        ...
        describe "m/0/2147483647p/1/2147483646p/2" do
          ...
          it "generates subnode" do
            ...
            expect(@node.to_address(format: :p2sh_p2wpkh)).to eql("3NUwiFMvp3CN1MYXkUjkoboYk7mHuQTTUn")
          end
